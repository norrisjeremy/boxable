...
public class TableTest {
	...
	public void SampleTest3() throws IOException {
		...
		Cell<PDPage> cell3 = row.createCell((100 / 3f), "I was wondering", HorizontalAlignment.get("center"),
				VerticalAlignment.get("bottom"), true);
		...
		Cell<PDPage> cell6 = row2.createCell((100 / 3f),
				...
				HorizontalAlignment.get("center"), VerticalAlignment.get("bottom"), true);
	...
	public void SampleTest5() throws IOException {
		...
		Cell<PDPage> cell2 = row.createCell((100 / 3f), "<i>Here is text in italic</i>",
				HorizontalAlignment.get("center"), VerticalAlignment.get("middle"), true);
		cell2.setFontSize(6);
		...
		Cell<PDPage> cell4 = row2.createCell((100 / 3.0f),
				...
				HorizontalAlignment.get("center"), VerticalAlignment.get("top"), true);
		cell4.setFontSize(6);
    ...
    public void IncorrectHTMLListNesting() throws IOException {
        ...
        //Create Header row
        Row<PDPage> row = table.createRow(15f);
        Cell<PDPage> cell = row.createCell((100 / 3f), "<ol><li>a</li><ol><li>b1</li><li>b2</li><ol><li>c1</li><li>c2 hello hello hello hello hello hello hello hello hello hello hello </li><li>c3</li><li>c4 hello hello hello hello hello hello hello hello hello hello</li></ol><li>b3</li></ol><li>hello</li><li>hello</li><li>hello</li><li>hello</li><li>hello</li></ol>", HorizontalAlignment.get("left"), VerticalAlignment.get("top"), true);
        Cell<PDPage> cell2 = row.createCell((100 / 3f), "<ul><li>a</li><ul><li>b1</li><li>b2</li><ul><li>c1</li><li>c2 hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello </li><li>c3</li><li>c4</li></ul><li>b3</li></ul><li>hello</li><li>hello</li><li>hello</li><li>hello</li></ul>", HorizontalAlignment.get("left"), VerticalAlignment.get("top"), true);
        table.draw();
